 ...
 * while neither the home experiment nor the orchestrator is armed, so a stored
 * preference cannot open a view that does not exist yet. `"last"` is returned
 * as-is for the boot path to keep doing what it already does.
 */
