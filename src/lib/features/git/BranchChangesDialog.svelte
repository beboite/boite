  ...
  >
    <div class="px-5 py-4">
      ...
      <p class="mt-1.5 text-xs leading-relaxed text-muted-foreground">
        ...
        <span class="font-mono text-foreground/90">{branch}</span> {i18n.t("branch_dialog.description_part2")}
      </p>
      ...
      <div class="mt-4 grid gap-2">
        ...
        >
          ...
          <span class="min-w-0">
            ...
            <span class="mt-0.5 block text-[11px] leading-snug text-muted-foreground">
              {i18n.t("branch_dialog.leave_changes_desc", { command: "git stash pop" })}
            </span>
          </span>
        </button>
        {/if}
