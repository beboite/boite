...
export interface SetupDraft {
  shortcuts: Shortcut[];
  /** Enhanced telemetry. The anonymous counters are always on after skip or finish. */
  modeB: boolean;
}

export interface SetupStepProps {
  draft: SetupDraft;
  /** Telemetry step only: choosing a mode also finishes the wizard. */
  onTelemetryChosen?: (modeB: boolean) => void;
}
...
export const SETUP_STEPS: SetupStep[] = [
  ...
  { id: "telemetry", component: TelemetryStep },
];
