...
export const FR_MESSAGES: Record<MessageKey, string> = {
  ...
  "setup.telemetryTitle": "Compteurs anonymes",
  "setup.telemetryDesc": "Boite peut envoyer quelques compteurs anonymes pour savoir si quelqu'un s'en sert et quoi corriger d'abord. Pas de compte, pas de noms, pas de chemins. Vous pourrez tout couper plus tard dans Paramètres, Confidentialité.",
  "setup.telemetryOverlayTitle": "Un mot sur les données d'usage",
  "setup.telemetryOverlayDesc": "Cette Boite peut maintenant envoyer quelques compteurs anonymes. Rien n'est parti pour l'instant. Choisissez une fois ; vous pourrez changer d'avis dans Paramètres, Confidentialité.",
  "setup.telemetryBasic": "Compteurs anonymes",
  "setup.telemetryBasicHint": "Des totaux quotidiens, sans profil. C'est le défaut.",
  "setup.telemetryEnhanced": "Aider un peu plus",
  "setup.telemetryEnhancedHint": "Les compteurs, plus la taille de votre espace de travail, pour voir à quoi ressemble une install dans le temps. Lié à un identifiant aléatoire sur cette machine, jamais à vous.",
  ...
  "privacy.modeADesc": "Des totaux quotidiens, sans profil. Désactivé, plus rien ne part.",
