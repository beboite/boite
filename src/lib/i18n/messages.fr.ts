...
export const FR_MESSAGES: Record<MessageKey, string> = {
  ...
  "pilot.placeholder": "Écrire à l'agent",
  "pilot.send": "Envoyer",
  "pilot.interrupt": "Interrompre",
  ...
  "pilot.reasoning": "Raisonnement",
  "pilot.toolCall": "{tool}",
  "pilot.command": "Commande",
  "pilot.fileChange": "{path}",
  "pilot.plan": "Plan",
  ...
  "pilot.picker": "Modèle",
  "pilot.pickerDriver": "Pilote",
  "pilot.pickerInstance": "Compte",
  "pilot.pickerModel": "Modèle",
  "pilot.pickerEffort": "Effort",
  "pilot.pickerMode": "Mode",
  "pilot.effortDefault": "par défaut",
