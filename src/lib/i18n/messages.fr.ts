...
export const FR_MESSAGES: Record<MessageKey, string> = {
  ...
  "sidebar.pinThread": "Épingler",
  "sidebar.unpinThread": "Désépingler",
  "sidebar.movePinUp": "Monter",
  "sidebar.movePinDown": "Descendre",
  "sidebar.settleThread": "Classer",
  "sidebar.unsettleThread": "Ressortir",
  "sidebar.snoozeThread": "Mettre en veille",
  "sidebar.unsnoozeThread": "Réveiller",
  "sidebar.snoozeHour": "Pour une heure",
  "sidebar.snoozeUntilTomorrow": "Jusqu'à demain",
  "sidebar.snoozeWeek": "Pour une semaine",
  "sidebar.filedAway": "Classés",
  "sidebar.showFiled": "Afficher les threads classés",
  "sidebar.hideFiled": "Masquer les threads classés",
  "sidebar.filedCount": "{count} classés",
  "sidebar.snoozedUntil": "Retour {when}",
  "sidebar.busyCannotFile": "Ce thread travaille, il reste sous tes yeux",
  "sidebar.fileThreadFailed": "Impossible de classer ce thread",
  "sidebar.pinThreadFailed": "Impossible de changer l'ordre des épinglés",
  ...
  "reply.aria": "Répondre à {thread}",
  "reply.failed": "Impossible de répondre à {thread}",
  "reply.yes": "Oui",
  "reply.no": "Non",
  "reply.enter": "Entrée",
  "reply.escape": "Échap",
  ...
  "fastpick.failedWithCode": "cargo s'est arrêté avec le code {code}. Le journal ci-dessous dit pourquoi.",
  "fastpick.failedToStart": "cargo n'a jamais démarré : {error}",
  ...
  "terminalTab.autoSettle": "Classement automatique",
  "terminalTab.autoSettleDesc": "Classe un thread tout seul quand plus rien ne s'y passe depuis un moment. Il ressort dès que son agent démarre un tour, et un thread épinglé n'est jamais classé.",
  "terminalTab.autoSettleAfter": "Classer après",
