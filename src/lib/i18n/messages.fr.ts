...
export const FR_MESSAGES: Record<MessageKey, string> = {
  ...
  "plugin.kebaccDesc": "Sauve et change les logins Claude Code et Codex. Quand un login n'a plus de quota, le prochain lancement de cet agent passe sur un compte qui en a encore.",
  "plugin.saveCurrentClaude": "Sauver le login Claude actuel",
  "plugin.saveCurrentCodex": "Sauver le login Codex actuel",
  "plugin.savedKebacc": "Login {provider} actuel sauvé.",
  "plugin.noAccountsKebacc": "Aucun login {provider} sauvé. Connectez-vous, puis sauvez-le ici.",
  "plugin.switchedKebacc": "Compte changé. Rechargement de {count} thread(s) {provider}.",
  "plugin.switchedNoneKebacc": "Compte changé. Aucun thread {provider} à recharger.",
  "plugin.claude": "Claude",
  "plugin.codex": "Codex",
  "plugin.autoOnLaunch": "Un lancement Claude ou Codex lance d'abord l'auto-switch, seulement si le login en cours est vide.",
  "plugin.untrusted": "non fiable",
  "plugin.unsealed": "texte brut",
  "plugin.autoSwitched": "{provider} basculé sur {email}. Rechargement des autres threads.",
