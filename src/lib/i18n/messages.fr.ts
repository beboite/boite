...
export const FR_MESSAGES: Record<MessageKey, string> = {
  ...
  "tabs.accountsHint": "Avec quel compte se connecte un agent que vous lancez.",
  "tabs.devicesHint":
  ...
  "accounts.settingsTitle": "Changeur de compte",
  "accounts.settingsDesc": "Garde plusieurs comptes Claude et Codex côte à côte, et passe de l'un à l'autre.",
  "accounts.recheck": "Revérifier",
  "accounts.installed": "Installé",
  "accounts.notInstalled": "Pas sur cette machine",
  "accounts.install": "Installer",
  "accounts.update": "Mettre à jour",
  "accounts.uninstall": "Désinstaller",
  "accounts.doctor": "Diagnostic",
  "accounts.savedAccounts": "{claude} comptes Claude, {codex} comptes Codex enregistrés.",
  "accounts.runsHere": "S'exécute ici, dans ce panneau. Arrêtez-le quand vous voulez.",
  "accounts.keepsAccounts": "La désinstallation ne retire que les outils. Vos comptes enregistrés restent.",
  "accounts.updateAvailable": "v{version} est fournie avec cette version de Boite",
  "accounts.vendored": "Les outils sont fournis dans Boite. Rien n'est téléchargé pour les installer.",
  "accounts.needsPwsh": "Nécessite PowerShell 7 : pwsh est introuvable.",
  "accounts.needsPwshHelp": "Installez-le depuis github.com/PowerShell/PowerShell, puis revérifiez.",
  "accounts.runningInstall": "Écriture des outils dans votre dossier personnel et installation.",
  "accounts.runningUpdate": "Écriture de la dernière version des outils par-dessus celle installée.",
  "accounts.runningUninstall": "Suppression des outils. Les comptes enregistrés ne sont pas touchés.",
  "accounts.runningDoctor": "On demande au changeur ce qu'il voit.",
  "accounts.finished": "Terminé.",
  "accounts.failedWithCode": "{cmd} s'est arrêté avec le code {code}. Le journal ci-dessous dit pourquoi.",
  "accounts.failedToStart": "{cmd} n'a jamais démarré : {error}",
  "accounts.cancelled": "Arrêté avant la fin.",
  "accounts.stop": "Arrêter",
  "accounts.retry": "Réessayer",
  "accounts.clearLog": "Effacer",
  "accounts.copyLog": "Copier le journal",
  "accounts.logCopied": "Journal copié",
  ...
  "accounts.addProjectFirst": "Ajoutez d'abord un projet",
