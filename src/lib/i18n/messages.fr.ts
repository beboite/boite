...
export const FR_MESSAGES: Record<MessageKey, string> = {
  ...
  "tabs.pluginsHint": "Les outils auxquels Boite parle. Leur source reste hors de ce dépôt.",
  "tabs.devicesHint":
  ...
  "plugin.claudeTitle": "Changeur de compte Claude",
  "plugin.claudeDesc": "Passe au login Claude Code suivant quand l'actuel est à sec. Boite relance ensuite les threads Claude.",
  "plugin.codexTitle": "Changeur de compte Codex",
  "plugin.codexDesc": "Le même contrat que le changeur Claude, pour Codex.",
  "plugin.claudeContract": "Cherche claude-cc dans le PATH, ou ~/.claude-tools/claude-cc.ps1.",
  "plugin.codexContract": "Cherche codex-cc dans le PATH, ou ~/.codex-tools/codex-cc.ps1.",
  "plugin.installed": "Installé",
  "plugin.notInstalled": "Absent de cette machine",
  "plugin.recheck": "Revérifier",
  "plugin.switchNext": "Passer au compte suivant",
  "plugin.switching": "Changement…",
  "plugin.switchFailed": "Le changeur a répondu : {error}",
  "plugin.switched": "Compte changé. Rechargement de {count} thread(s).",
  "plugin.switchedNone": "Compte changé. Aucun thread de cet agent à recharger.",
  "plugin.current": "actuel",
  "plugin.limited": "à sec",
  "plugin.noAccounts": "Le changeur n'a signalé aucun compte enregistré.",
  "plugin.rawStatus": "Ce CLI n'a pas de statut JSON. Son texte est ci-dessous.",
  "plugin.missingHint": "Installez le changeur et mettez sa commande dans le PATH. Il doit répondre à status --json et switch --json.",
