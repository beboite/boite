...
export const FR_MESSAGES: Record<MessageKey, string> = {
  ...
  "plugin.claudeDesc": "Passe au login Claude Code suivant quand l'actuel est à sec. S'installe depuis ce panneau, comme fastpick, dès qu'il a un dépôt publié.",
  "plugin.codexTitle": "Changeur de compte Codex",
  "plugin.codexDesc": "La même idée pour Codex. S'installe depuis ce panneau dès qu'il a un dépôt publié.",
  "plugin.notInstalled": "Absent de cette machine",
  "plugin.noPackage": "Pas de paquet publié. Dès qu'il a un dépôt git, installer et mettre à jour se font depuis cette carte, comme fastpick.",
