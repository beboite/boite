...
export const EN_MESSAGES = {
  ...
  "setup.telemetryTitle": "Anonymous usage",
  "setup.telemetryDesc": "Boite can send a few anonymous counters so we know whether anyone uses this and what to fix first. No account, no names, no paths. You can switch it off later in Settings, Privacy.",
  "setup.telemetryOverlayTitle": "A word about usage data",
  "setup.telemetryOverlayDesc": "This Boite can now send a few anonymous counters. Nothing has been sent yet. Choose once; you can change it later in Settings, Privacy.",
  "setup.telemetryBasic": "Anonymous counters",
  "setup.telemetryBasicHint": "Daily counts, no profile. This is the default.",
  "setup.telemetryEnhanced": "Help more",
  "setup.telemetryEnhancedHint": "The counters, plus how your workspace is sized, so we can see what a typical install looks like over time. Tied to a random id on this machine, never to you.",
  ...
  "privacy.modeADesc": "Daily counts with no profile. Off means nothing is sent.",
