...
export const EN_MESSAGES = {
  ...
  "tabs.pluginsHint": "Tools Boite talks to. Their source stays outside this repo.",
  ...
  "plugin.claudeTitle": "Claude account switcher",
  "plugin.claudeDesc": "Rotates saved Claude Code logins when one hits its limit. Boite reloads the Claude threads afterwards.",
  "plugin.codexTitle": "Codex account switcher",
  "plugin.codexDesc": "Same contract as the Claude switcher, for Codex.",
  "plugin.claudeContract": "Looks for claude-cc on PATH, or ~/.claude-tools/claude-cc.ps1.",
  "plugin.codexContract": "Looks for codex-cc on PATH, or ~/.codex-tools/codex-cc.ps1.",
  "plugin.installed": "Installed",
  "plugin.notInstalled": "Not on this machine",
  "plugin.recheck": "Check again",
  "plugin.switchNext": "Switch to the next account",
  "plugin.switching": "Switching…",
  "plugin.switchFailed": "The switcher said: {error}",
  "plugin.switched": "Switched. Reloading {count} thread(s).",
  "plugin.switchedNone": "Switched. No thread of this agent needed a reload.",
  "plugin.current": "current",
  "plugin.limited": "at limit",
  "plugin.noAccounts": "The switcher reported no saved accounts.",
  "plugin.rawStatus": "This CLI has no JSON status. Its text is below.",
  "plugin.missingHint": "Install the switcher and put its command on PATH. It must answer status --json and switch --json.",
  "mobile.files": "Files",
