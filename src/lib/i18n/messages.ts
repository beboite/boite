...
export const EN_MESSAGES = {
  ...
  "chat.section": "Chats",
  "chat.new": "New chat",
  "chat.newHint": "Talk to an agent without picking a folder",
  "chat.untitled": "New chat",
  "chat.pickOne": "Pick a chat, or start one.",
  "chat.emptyHint": "Ask anything. When it turns into something real, the agent can make it a project.",
  "chat.placeholder": "Message the agent…",
  "chat.pickAgent": "Change agent",
  "chat.send": "Send",
  "chat.stop": "Stop",
  "chat.noAgents": "No agent installed",
  "chat.modeTerminal": "terminal",
  "chat.fallbackNotice":
    "{agent} has no print mode Boite can vouch for, so its answers come back as a terminal.",
  "chat.turnFailed": "That turn did not finish.",
  "chat.deleteTitle": "Delete chat?",
  "chat.deleteMessage": "Delete {name}? The conversation goes with it.",
  "chat.deleteConfirm": "Delete chat",
  "chat.handoverProjectTitle": "Make this a project: {name}",
  "chat.handoverThreadTitle": "Continue this in a terminal",
  "chat.handoverExplain":
    "The agent asked for this. Boite creates the folder, adds the project and opens a terminal carrying the transcript — nothing happens until you press the button.",
  "chat.handoverConfirm": "Create it and open a terminal",
  "chat.handoverWorking": "Setting it up…",
  ...
  "project.chatHint": "Ask an agent about this project — it starts in the folder.",
