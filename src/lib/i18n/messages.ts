...
export const EN_MESSAGES = {
  ...
  "plugin.claudeDesc": "Rotates saved Claude Code logins when one hits its limit. Installed from this panel, the way fastpick is, once it has a published repo.",
  "plugin.codexTitle": "Codex account switcher",
  "plugin.codexDesc": "Same idea for Codex. Installed from this panel once it has a published repo.",
  "plugin.notInstalled": "Not on this machine",
  "plugin.noPackage": "No published package yet. The moment it has a git repo, install and update run from this card, like fastpick.",
  "mobile.files": "Files",
