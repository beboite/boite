...
export const EN_MESSAGES = {
  ...
  "tabs.pluginsHint": "Tools Boite installs and updates for you. fastpick is the first.",
  ...
  "plugin.saved": "Current Codex login saved.",
  "plugin.saveFailed": "Save failed: {error}",
  "plugin.switchFailed": "The switcher said: {error}",
  "plugin.switched": "Switched. Reloading {count} Codex thread(s).",
  "plugin.switchedNone": "Switched. No Codex thread needed a reload.",
  "plugin.current": "current",
  "plugin.noAccounts": "No saved Codex login yet. Sign in with Codex, then save it here.",
  "plugin.kebaccTitle": "kebacc-switch",
  "plugin.kebaccDesc": "Saves and switches Claude Code and Codex logins. When a login is out of quota, the next launch of that agent moves to one that still has room.",
  "plugin.saveCurrentClaude": "Save the current Claude login",
  "plugin.saveCurrentCodex": "Save the current Codex login",
  "plugin.savedKebacc": "Current {provider} login saved.",
  "plugin.noAccountsKebacc": "No saved {provider} login yet. Sign in, then save it here.",
  "plugin.switchedKebacc": "Switched. Reloading {count} {provider} thread(s).",
  "plugin.switchedNoneKebacc": "Switched. No {provider} thread needed a reload.",
  "plugin.claude": "Claude",
  "plugin.codex": "Codex",
  "plugin.autoOnLaunch": "A Claude or Codex launch runs auto-switch first, only if the live login is empty.",
  "plugin.untrusted": "not trusted",
  "plugin.unsealed": "plain text",
  "plugin.autoSwitched": "Switched {provider} to {email}. Reloading other threads.",
  "mobile.files": "Files",
