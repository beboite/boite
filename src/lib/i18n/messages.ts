...
export const EN_MESSAGES = {
  ...
  "tabs.accountsHint": "Which login an agent you launch signs in as.",
  ...
  "fastpick.failedWithCode": "{cmd} stopped with code {code}. The log below says why.",
  "fastpick.failedToStart": "{cmd} never ran: {error}",
  ...
  "accounts.settingsTitle": "Account switcher",
  "accounts.settingsDesc": "Keeps several Claude and Codex logins side by side, and switches between them.",
  "accounts.recheck": "Check again",
  "accounts.installed": "Installed",
  "accounts.notInstalled": "Not on this machine",
  "accounts.install": "Install",
  "accounts.update": "Update",
  "accounts.uninstall": "Uninstall",
  "accounts.doctor": "Self-check",
  "accounts.savedAccounts": "{claude} Claude logins, {codex} Codex logins saved.",
  "accounts.runsHere": "Runs here, in this panel. Stop it whenever you like.",
  "accounts.keepsAccounts": "Uninstalling removes the tools only. Your saved logins stay.",
  "accounts.updateAvailable": "v{version} ships with this build",
  "accounts.vendored": "The tools ship inside Boite. Nothing is downloaded to install them.",
  "accounts.needsPwsh": "Needs PowerShell 7: pwsh was not found.",
  "accounts.needsPwshHelp": "Install it from github.com/PowerShell/PowerShell, then check again.",
  "accounts.runningInstall": "Writing the tools into your home directory and setting them up.",
  "accounts.runningUpdate": "Writing the newest version of the tools over the one installed.",
  "accounts.runningUninstall": "Removing the tools. Saved logins are left alone.",
  "accounts.runningDoctor": "Asking the switcher what it can see.",
  "accounts.finished": "Done.",
  "accounts.failedWithCode": "{cmd} stopped with code {code}. The log below says why.",
  "accounts.failedToStart": "{cmd} never ran: {error}",
  "accounts.cancelled": "Stopped before it finished.",
  "accounts.stop": "Stop",
  "accounts.retry": "Try again",
  "accounts.clearLog": "Clear",
  "accounts.copyLog": "Copy log",
  "accounts.logCopied": "Log copied",
  "mobile.files": "Files",
  ...
  "accounts.addProjectFirst": "Add a project first",
