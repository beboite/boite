...
export const strings = {
  ...
  plugins: {
    ...
    browserHint: 'Jev reads page content through TypeSafe and chooses actions in a separate, hidden browser. Each task starts with a fresh profile.',
    browserEnabled: 'Allow agents to delegate browser tasks',
    browserExecutable: 'Browser executable',
    browserExecutableHint: 'Optional absolute path to Chrome, Edge or Chromium.',
    browserKeyReady: 'TypeSafe key available on this machine',
    browserKeyMissing: 'Set TYPESAFE_API_KEY in the core environment, then restart the core.',
    browserSave: 'Save browser settings',
    browserSaved: 'Browser settings saved',
    browserTasks: 'Recent browser tasks',
    browserEmpty: 'No browser tasks yet. Agents can start one with boite browser run.',
    browserProgress: 'Step {step} of {max} · {tokens} input tokens',
    browserStatus: { running: 'Running', succeeded: 'Verified', 'needs-agent': 'Needs the agent', error: 'Failed', cancelled: 'Cancelled' },
    heading: 'Plugins',
