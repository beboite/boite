...
export const strings = {
  ...
  workflow: {
    heading: 'Workflows',
    panelHint: 'Follow step graphs',
    empty: 'No workflow on this thread yet.',
    emptyHint: 'Ask the agent for one: it writes the steps, Boite runs them on the team profiles.',
    runs: 'Runs',
    ...
    retry: 'Retry',
    stopTitle: 'Stop "{name}"?',
    stopBody: 'Running steps are stopped and the rest never starts. Finished steps keep their results.',
    byAgent: 'Planned by the agent',
    byUser: 'Started by you',
    forEach: 'One per item of {path}',
    after: 'After {steps}',
    condition: 'Only if {path}',
    task: 'Task',
    result: 'Result',
    output: 'Output',
    items: 'Executions',
    ...
    openThread: 'Open conversation',
    back: 'Back to the graph',
    close: 'Close details',
    notStarted: 'Not started yet.',
    skipped: 'Skipped: its condition did not hold.',
    delivered: 'The results went back to the conversation.',
    waitingDelivery: 'The results go back to the conversation once it is idle.',
    templates: 'Saved workflows',
    noTemplates: 'Nothing saved in this project.',
    ...
    removeBody: 'Runs already started from it are kept.',
    remove: 'Delete',
    ownerOnly: 'Only the owner can resume, retry or start a workflow.',
    card: 'Workflow',
