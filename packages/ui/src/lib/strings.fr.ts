...
export const fr: Messages = {
  ...
  intro: 'Envoyez une même demande à deux agents dans des worktrees Git séparés. Chacun utilise le mode de permission Demander.',
  prompt: 'Demande commune',
  placeholder: 'Décrivez le changement que les deux agents doivent proposer.',
  first: 'Proposition A',
  second: 'Proposition B',
  launch: 'Lancer les deux propositions',
  launching: 'Lancement des propositions',
  close: 'Fermer',
  continue: 'Continuer dans cette conversation',
  empty: 'La réponse apparaîtra ici.',
  waiting: 'Ouvrez la conversation pour répondre à la demande de permission ou à la question.',
  independent: 'Fermer cette vue ne coupe pas les conversations en cours. Continuez dans une conversation pour examiner ses modifications.',
  created: 'La conversation a été créée, mais son démarrage reste à confirmer. Ouvrez-la avant de renvoyer la demande.',
  unavailable: 'La comparaison nécessite une connexion propriétaire à cette machine.',
  noTarget: 'Choisissez un fournisseur et un compte disponibles pour chaque proposition.',
  changed: 'La connexion à la machine a changé. Ouvrez les conversations créées sur leur machine d’origine.',
  newComparison: 'Nouvelle comparaison',
  refresh: 'Actualiser',
  starting: 'Démarrage',
  failed: 'Échec du démarrage',
  ready: 'Prêt',
  noText: 'Pas encore de réponse textuelle. Ouvrez la conversation pour voir les outils et les autres résultats.'
},
  ...
  experiments: {
    ...
    proposalComparison: { title: 'Comparer les propositions', hint: 'Envoyer une même demande à deux agents dans des worktrees séparés et comparer leurs réponses' },
