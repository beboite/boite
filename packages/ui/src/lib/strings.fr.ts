...
export const fr: Messages = {
  agents: {
    ...
    list: 'Liste', scene: 'Vue studio', create: 'Créer', edit: 'Configurer', save: 'Enregistrer', cancel: 'Annuler', close: 'Fermer',
    search: 'Rechercher un agent, groupe, équipe ou mission', empty: 'Rien ici pour le moment.', select: 'Sélectionne un élément pour voir son activité.',
    name: 'Nom', domain: 'Domaine', instructions: 'Instructions', identityHint: 'Changer de modèle conserve son identité et sa mémoire.',
    ...
    conversation: 'Conversation', activity: 'Activité', send: 'Envoyer', message: 'Écrire un message', recipients: 'Destinataires', everyone: 'Suivre la règle du groupe',
    ...
    sceneHint: 'Personnages : agents. Tables : groupes. Espaces : équipes. Clique pour ouvrir.',
    sceneLabel: 'Studio des agents', sceneEmpty: 'Crée des agents et des groupes pour remplir le studio.',
