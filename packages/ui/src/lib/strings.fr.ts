...
export const fr: Messages = {
  ...
  plugins: {
    browserTitle: 'Automatisation du navigateur',
    browserHint: 'Jev lit le contenu des pages via TypeSafe et choisit les actions dans un navigateur séparé et masqué. Chaque tâche démarre avec un profil vierge.',
    browserEnabled: 'Autoriser les agents à déléguer des tâches au navigateur',
