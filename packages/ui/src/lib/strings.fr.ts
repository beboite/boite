...
export const fr: Translation = {
  ...
  workflow: {
    heading: 'Workflows',
    panelHint: "Suivre les graphes d'étapes",
    empty: "Aucun workflow sur ce fil pour l'instant.",
    emptyHint: "Demandez-en un à l'agent : il écrit les étapes, Boite les lance sur les profils de l'équipe.",
    runs: 'Exécutions',
    ...
    stopBody: "Les étapes en cours s'arrêtent et les suivantes ne démarrent pas. Les étapes finies gardent leurs résultats.",
    byAgent: "Planifié par l'agent",
    byUser: 'Lancé par vous',
    forEach: 'Une par élément de {path}',
    after: 'Après {steps}',
    condition: 'Seulement si {path}',
    task: 'Tâche',
    result: 'Résultat',
    output: 'Sortie',
    items: 'Exécutions',
    ...
    openThread: 'Ouvrir la conversation',
    back: 'Retour au graphe',
    close: 'Fermer le détail',
    notStarted: 'Pas encore démarrée.',
    skipped: "Sautée : sa condition n'était pas remplie.",
    delivered: 'Les résultats sont revenus dans la conversation.',
    waitingDelivery: "Les résultats reviennent dans la conversation dès qu'elle est libre.",
    templates: 'Workflows enregistrés',
    noTemplates: "Rien d'enregistré dans ce projet.",
    ...
    removeBody: 'Les exécutions déjà lancées depuis ce modèle sont conservées.',
    remove: 'Supprimer',
    ownerOnly: 'Seul le propriétaire peut reprendre, relancer ou lancer un workflow.',
    card: 'Workflow',
    show: 'Voir le workflow',
