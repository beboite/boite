...
export const fr: Messages = {
  ...
  delegation: {
    heading: 'Agents',
    panelHint: 'Déléguer une tâche et suivre les agents',
    intro: 'Lancez des agents dans ce fil. Ils partagent son dossier de travail et ses permissions.',
    ...
    enabledHint: 'L’agent principal peut lancer des agents depuis les profils ci-dessous, sur un seul niveau.',
    ownerOnly: 'Vous pouvez suivre les agents, leur écrire et les arrêter. Seul le propriétaire peut modifier les profils, les limites ou lancer un agent.',
    profiles: 'Profils autorisés',
    profilesHint: 'Chaque profil définit le fournisseur, le compte, le modèle et l’effort autorisés.',
    ...
    launching: 'Lancement',
    taskPlaceholder: 'Donnez une tâche précise, les fichiers concernés et le résultat attendu.',
    team: 'Membres de l’équipe',
    empty: 'Aucun agent délégué pour le moment.',
    agentsShort: 'agents',
    turnsShort: 'tours',
    usage: 'Consommation de l’équipe',
    limitReached: 'Le budget de tours est épuisé. Les résultats restent disponibles. Le propriétaire doit relever la limite pour lancer de nouveaux tours.',
    ...
    queuedDelivery: 'Message en attente de transmission à cet agent.',
