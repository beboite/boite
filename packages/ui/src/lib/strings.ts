...
export const strings = {
  ...
  delegation: {
    heading: 'Agents',
    panelHint: 'Delegate bounded work and follow the team',
    intro: 'Launch approved agents in this thread. They share its checkout and permissions.',
    ...
    enabledHint: 'The parent agent can launch one level of children from the approved profiles below.',
    ownerOnly: 'You can follow, message and stop this team. Only the owner can change profiles, limits or launch an agent.',
    profiles: 'Approved profiles',
    profilesHint: 'Each profile fixes the provider, account, model and effort an agent may use.',
    ...
    launch: 'Launch agent',
    launching: 'Launching',
    taskPlaceholder: 'Give this agent one bounded task, including file ownership and the result you need.',
    team: 'Team members',
    empty: 'No delegated agent yet.',
    agentsShort: 'agents',
    turnsShort: 'turns',
    usage: 'Delegated team usage',
    limitReached: 'The team turn budget is spent. Results stay here, and new agent turns wait until the owner raises the limit.',
    ...
    send: 'Send to agent',
    queuedDelivery: 'Queued for delivery to this agent.'
  },
