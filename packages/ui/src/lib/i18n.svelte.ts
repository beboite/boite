 ...
 *
 * `lib/strings.ts` is English: the catalogue every other language mirrors, the
 ...
 * import of its own. Every module imports `strings` from here; `./strings`
 * itself is imported by this file and by the translations, nowhere else.
 */

import { strings as en, fill, type Strings } from './strings';
