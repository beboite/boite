...
export type OnboardingStep = 'welcome' | 'agents' | 'voice' | 'panel' | 'usage' | 'reach' | 'quiet' | 'project';
 ...
 */
const ORDER: readonly OnboardingStep[] = ['welcome', 'agents', 'voice', 'panel', 'usage', 'reach', 'quiet', 'project'];
