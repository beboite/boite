...
export class ThreadStore {
  ...
  private makeContext(
    ...
    return {
      ...
      provider,
      turn,
      prompt: prepared.prompt + (turn.execution?.operation === 'compact' ? '' : this.core.coordination.instructions(threadId) + this.core.delegation.instructions(threadId) + this.core.delegation.initialInput(threadId, turn.id)),
